...
#CLASSE PRINCIPAL, ESTRUTURA O AMBIENTE DO CORTE E EMPACOTAMENTO NO MODELO DA BIBLIOTECA GYM

class env2KP(gym.Env):
    def __init__(self, Base=None,Altura=None,x=-200,y=200,peças='fu',draw=False,escala=None,plot=False): #INICIALIZA O ESPAÇO DE OBSERVAÇÃO E AÇÃO
        ...
        self.observation_space = spaces.Dict({
            ...
            # Espaço de ação: escolha de uma peça, sua posição e rotação na área de corte
    ...
    def reset(self, seed=None): #REINICIA O AMBIENTE QUANDO A EPOCA ACABAR
        global X,Y,tempoF,grau,CordenadasProibidas,lista_colunas,fecho,lista_area_fechos,AreaPreenchida,l,fecho_turtle,dados_turtle,turtles,lista_poligonos,t,inicio,tempo_anterior,fim,Bot,nova_lista,nova_lista_completa,base,altura
    ...
    def step(self, action): #EXCUTA A AÇÃO NO AMBIENTE
        self.acao += 1
...
#MAIN, ONDE É TREINADO O MODELO
if __name__ == '__main__':
    env = env2KP #Cria um objeto do ambiente
    num_envs = 32
    ...
    model = PPO('MultiInputPolicy', envs, verbose=1, tensorboard_log=log_dir, #Estrutura a arquitetura e hiperparametros do PPO
    ...
    model.learn(total_timesteps=500_000) #Executa o treinnamento do modelo
...
###############################################################################
# AS DEMAIS FUNÇÕES SÃO AUXILIARES, PARA QUE POSSA SER EXECUTADO O TREINAMENTO#
###############################################################################
